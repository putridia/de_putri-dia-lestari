...
class Yoga(KelasLatihan):
    ...
    def pesanKelas(self, tingkatKesulitan):
        if self._KelasLatihan__tersedia and self.__tingkatKesulitan == tingkatKesulitan:
...
if __name__ == "__main__":
    # Buat objek Yoga
    yoga_kelas = Yoga("Dhani", "Yoga Instructor", 6, "Yoga", "Senin, Selasa, Kamis", "Intermediate")

    # Buat objek AngkatBeban
    angkat_beban_kelas = AngkatBeban("Johan", "Weightlifting", 2, "Angkat Beban", "Sabtu, Minggu", 50)
